...
console.log("Esercizion 1: ", charactersNames);
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  const femgenObj = starWarsCharacters[i];

  if (femgenObj.gender === "female") {
    femaleCharacters.push(femgenObj.name);
  }
}
...
console.log("Esercizio 7: ", crewMass);
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  const gendreass = starWarsCharacters[i];

  if (gendreass.gender === "n/a") {
    newgen.push((gendreass.gender = "Robot"));
  }
}

console.log("Esercizio 8: ", newgen);
